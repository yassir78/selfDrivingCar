...
export class CyberTruck {
  ...
  constructor(licensePlateImg) {
    ...
    // right
    let lowerRFrontLightVerticesArr = lowerLFrontLightVerticesArr.map(
        flipXVertices
      ),
    ...
    let rightSmallBackLightVerticesArr = leftSmallBackLightVerticesArr.map(
        flipXVertices
      ),
      rightSmallBackLightVertices = rightSmallBackLightVerticesArr.map(
        toVectors
      ),
      rightSmallBackLightFacesArr = leftSmallBackLightFacesArr.map(
        reverseFaceDraws
      ),
